...
namespace transform.mc
{
	...
	public class _opBang : Expr
	{
		...
		public override string ToString()
		{
			...
			res += " ! ";
			if (P1 is System.Collections.IEnumerable)
			{
				res += "{";
				foreach (var x in P1 as System.Collections.IEnumerable)
					res += x.ToString();
				res += "}";
			}
			else
	...
	public class _opBitwiseAnd : Expr
	{
		...
		public _opBitwiseAnd(Expr P1, Expr P2)
		{
			this.P1 = P1; this.P2 = P2;
		}

		public static _opBitwiseAnd Create(Expr P1, Expr P2)
		{
			return new _opBitwiseAnd( P1, P2 );
		}
		...
		public override string ToString()
		{
			...
			res += " & ";
			if (P2 is System.Collections.IEnumerable)
			{
				res += "{";
				foreach (var x in P2 as System.Collections.IEnumerable)
					res += x.ToString();
				res += "}";
			}
			else
		...
		public override bool Equals( object other )
		{
			...
			if( tmp != null )
				return this.P1.Equals( tmp.P1 ) && this.P2.Equals( tmp.P2 );
			else return false;
		}
	...
	public class eval : Expr
	{
		...
		public static eval Create(Expr P1)
		{
			return new eval( P1 );
		}
...
#line 17 ".\Content\Boolean expressions\transform.mc"
		...
		public static Value StaticRun0_()
		{
			return StaticRun();
		}
	...
	public class _opBitwiseOr : Expr
	{
		...
		public _opBitwiseOr(Expr P1, Expr P2)
		{
			this.P1 = P1;
			this.P2 = P2;
		}

		public static _opBitwiseOr Create(Expr P1, Expr P2)
		{
			return new _opBitwiseOr( P1, P2 );
		}
		...
		public override string ToString()
		{
			...
			{
				res += "{";
				foreach (var x in P2 as System.Collections.IEnumerable) res += x.ToString();
				res += "}";
			}
			else
			{
