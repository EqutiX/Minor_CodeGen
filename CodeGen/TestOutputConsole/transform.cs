...
namespace transform
{
	...
	public class _opHat : Expr
	{
		public Expr P1;
		public Expr P2;

		public _opHat(Expr P1, Expr P2) { this.P1 = P1; this.P2 = P2; }
		public static _opHat Create(Expr P1, Expr P2) { return new _opHat(P1, P2); }
